// Cloned from github.com/google/netstack/tmutex at 2017-08-01, nothing changed except the package name.

// Package xmutex provides the implementation of a mutex that implements an
